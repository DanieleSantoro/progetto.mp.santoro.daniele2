...
public final class SimpleTask extends TurnaroundTask {
    ...
    public SimpleTask(String name, int minutes, Set<Resource> requiredResources) {
        ...
        this.requiredResources = Collections.unmodifiableSet(new HashSet<>(Objects.requireNonNull(requiredResources)));
    }
